...
#endif
{
    ...
    treeState.addParameterListener(DRIVE_ID, this);
    treeState.addParameterListener(BIT_ID, this);
    treeState.addParameterListener(DWNSMP_ID, this);
    treeState.addParameterListener(DRYWET_ID, this);
    treeState.addParameterListener(INPUT_ID, this);
    treeState.addParameterListener(OUTPUT_ID, this);
    treeState.addParameterListener(RND_DURATION_ID, this);
    treeState.addParameterListener(RND_INTERVAL_ID, this);
    treeState.addParameterListener(DELAYAMOUNT_ID, this);
    treeState.addParameterListener(DELAYTIME_ID, this);
    treeState.addParameterListener(CLIPPER_ID, this);
    treeState.addParameterListener(SATURATION_ID, this);
    treeState.addParameterListener(FADEIN_ID, this);
    treeState.addParameterListener(FADEOUT_ID, this);
    treeState.addParameterListener(ANTIALIASING_ID, this);
}

ANTARCTICAAudioProcessor::~ANTARCTICAAudioProcessor()
{
    treeState.removeParameterListener(GAIN_ID, this);
    treeState.removeParameterListener(DRIVE_ID, this);
    treeState.removeParameterListener(BIT_ID, this);
    treeState.removeParameterListener(DWNSMP_ID, this);
    treeState.removeParameterListener(DRYWET_ID, this);
    treeState.removeParameterListener(INPUT_ID, this);
    treeState.removeParameterListener(OUTPUT_ID, this);
    treeState.removeParameterListener(RND_DURATION_ID, this);
    treeState.removeParameterListener(RND_INTERVAL_ID, this);
    treeState.removeParameterListener(DELAYAMOUNT_ID, this);
    treeState.removeParameterListener(DELAYTIME_ID, this);
    treeState.removeParameterListener(CLIPPER_ID, this);
    treeState.removeParameterListener(SATURATION_ID, this);
    treeState.removeParameterListener(FADEIN_ID, this);
    treeState.removeParameterListener(FADEOUT_ID, this);
    treeState.removeParameterListener(ANTIALIASING_ID, this);
}

void ANTARCTICAAudioProcessor::parameterChanged(const juce::String& parameterID, float newValue)
{
    if (parameterID == GAIN_ID)             local_gain = newValue;
    else if (parameterID == DRIVE_ID)       local_drive = newValue;
    else if (parameterID == BIT_ID)         local_bit = newValue;
    else if (parameterID == DWNSMP_ID)      local_dwnsmp = newValue;
    else if (parameterID == DRYWET_ID)      local_drywet = newValue;
    else if (parameterID == INPUT_ID)       local_input = newValue;
    else if (parameterID == OUTPUT_ID)      local_output = newValue;
    else if (parameterID == DELAYAMOUNT_ID) local_delayAmount = newValue;
    else if (parameterID == DELAYTIME_ID)   local_delayTime = newValue;
    else if (parameterID == RND_DURATION_ID) local_rnd_duration = newValue;
    else if (parameterID == RND_INTERVAL_ID) local_rnd_interval = newValue;
    else if (parameterID == SATURATION_ID)  local_saturation = newValue;
    else if (parameterID == CLIPPER_ID)     local_clipper = newValue;
    else if (parameterID == FADEIN_ID)      local_fadein = newValue;
    else if (parameterID == FADEOUT_ID)     local_fadeout = newValue;
    else if (parameterID == ANTIALIASING_ID) local_antialiasing = newValue;
}
